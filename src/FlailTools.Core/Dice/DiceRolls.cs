...
/// <remarks>
/// <para>
/// Drawn through the engine's <see cref="DiceRoller"/> on a <see cref="Pcg32"/> stream rather than
/// from <c>Random</c>, for the same reason every other roll in this tool is: the algorithm is fixed
